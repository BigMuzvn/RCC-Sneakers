 ...
 *
 * Un administrateur ne passe plus par l'espace client — il est renvoyé ici dès
 * sa connexion. C'est donc le seul endroit où il puisse encore changer son mot
 * de passe, et sans cette carte il n'en aurait plus aucun.
 */
function MonCompte() {
  ...
  return (
    <section className={`${cardClass} p-5 sm:p-6`}>
      <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-white/45">Mon compte</p>
      <p className="mt-2 text-[10px] leading-[1.6] text-white/30">
        Vos propres identifiants d'administrateur. Changer de mot de passe déconnecte vos autres appareils ; celui-ci
        reste connecté.
      </p>
